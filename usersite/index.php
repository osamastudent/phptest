                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">Pakistan</h1>
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">THIS IS SLIDER <BR> PAKISTAN ZINDABAD</BR>.</p>
                                    <!-- Hero-btn -->
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="images/n7.jpg" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">This is slider.</p>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="#" class="btn hero-btn">Shop Now</a>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="images/m4.jpg" height="250">
                            </div>
                            <div class="product-caption">
                                <h3><a href="product_details.html">Mouse</a></h3>
                                <span>RS.250</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                            <img src="images/k6.jpg" height="250">
                            </div>
                            <div class="product-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                            <img src="images/l6.jpg" height="250">
                            </div>
                            <div class="product-caption">
                                <h3><a href="#">Lap Top</a></h3>
                                <span>Rs.34000</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image: url(images/classphoto.jpg);"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img big-img" style="background-image:  url(images/osamapic.png);"></div>
                        </div>
                    </div>
                    ...
                    <form action="addtocart.php" method="post">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="../product/productimages/<?php echo $row['p_image'] ?>" height=300px;>
                                <input type="hidden" name="pimage" value="<?php echo $row['p_image'] ?>">
                            ...
                            <div class="popular-caption">
                               ...
                               <input type="hidden" name="pdetail" value="<?php echo $row['p_detail'] ?>">
                               Rs. <?php  echo $row['p_price'] ?> <br>
                               <input type="hidden" name="pprice" value="<?php echo $row['p_price'] ?>">
                              
                               <div class="d-flex">
                               <input type="number" placeholder="enter quantity" name="pqty" id="">     
                               <input type="submit" name="addtocart" value="Add to cart" class="btn btn-outline-primary  hover-light"">
                ...
                <div class="row align-items-center justify-content-between padding-130">
                    <div class="col-lg-5 col-md-6">
                        <div class="watch-details mb-40">
                            ...
                            <p>water proof watches with 1 year warranty.</p>
